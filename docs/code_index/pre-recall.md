...
message ──► deriveRecallQueries (embed, no subprocess)
        ...
        ──► runText (claude|opencode|codex, PRE_RECALL_TIMEOUT_MS)
              ...
              └─ fail/uncited   ──► top-3 raw claims, cosine >= 0.5
