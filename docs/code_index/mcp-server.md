...
| `src/codex-app-server/spawner.ts` | Routes native approval callbacks through the shared Slack approval bridge; enables the local Codex environment for registered worktree-verification sessions and trusted utility workflows. |
