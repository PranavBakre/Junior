...
tools: Read, Grep, Glob, Bash(gh *), mcp__slack-bot__github_read_pr_review_state, mcp__slack-bot__github_post_review, mcp__slack-bot__slack_send_message, mcp__slack-bot__slack_read_thread, mcp__slack-bot__register_worktree, mcp__slack-bot__memory_recall, mcp__slack-bot__memory_add, mcp__slack-bot__memory_feedback
