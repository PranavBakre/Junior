...
operational.role: reproducer
operational.capabilities: repo-read, browser-read, pipeline-artifact-write, dispatch
operational.mutationPolicy: none
operational.mayDelegateTo: build, frontend, review, orchestrator, human
